...
pub const AGENTS: &[AgentDef] = &[
    ...
    AgentDef {
        ...
        // Prime Agent runs in full YOLO mode by default (no approval gates), so no flag needed.
        yolo: Some(YoloMode::AlwaysYolo),
        instruction_flag: None,
        set_default_command: false,
    ...
    AgentDef {
        ...
        launch_subcommand: None,
        aliases: &[],
        detection: DetectionMethod::Which("qodercli"),
        yolo: Some(YoloMode::CliFlag("--dangerously-skip-permissions")),
        instruction_flag: None,
        set_default_command: false,
        detect_status: status_detection::detect_qodercli_status,
        container_env: &[(
            "QODER_CONFIG_DIR",
            "/root/.qoder",
        )],
